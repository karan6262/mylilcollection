...
<%
    ...
    ResultSet rs = st.executeQuery("select * from prod_detail where prod_type= 'Accessories'");
...
.dropdown:hover .dropdown-content {
 ...
 %> <i class="fa fa-caret-down"></i>
            ...
            <div class="shop-menu">
                <ul>
                    <a href="#"><li class="active">Accessories</li></a>
                    ...
                    <div class="product-image-wrapper">
                        <div class="single-product">
                            <div class="productinfo text-center">
                                ...
                                <h3>&#x20b9 <%= rs.getDouble("prod_price")%></h3>
                                <p><%= rs.getString("prod_name")%></p>
                                 <a href="item.jsp?prod_id=<%= rs.getInt("prod_id")%>"><button value="View">View Item</button></a>
                            </div>
                        </div>
                    </div>
                </div>
